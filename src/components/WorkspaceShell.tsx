  ...
  return (
    <div className="workspace-shell">
      ...
      <div className="workspace-body">
        <LeftPanel mobileActive={mobilePanel === "left"}>{leftContent}</LeftPanel>
        <CenterPanel mobileActive={mobilePanel === "center"}>{centerContent}</CenterPanel>
        <RightPanel mobileActive={mobilePanel === "right"} resultContent={rightResultContent} />
      </div>
    </div>
  );
}
