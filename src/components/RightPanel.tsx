...
const TIMELINE_ITEMS = [
  { id: "upload", label: "파일 업로드", time: "대기 중", status: "pending" as const },
  { id: "stt", label: "STT 변환", time: "—", status: "pending" as const },
  { id: "speaker", label: "화자 분리", time: "—", status: "pending" as const },
  { id: "draft", label: "초안 생성", time: "—", status: "pending" as const },
];
...
export function RightPanel({ mobileActive = false }: RightPanelProps) {
